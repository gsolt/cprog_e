...
sT[0].sCP[0].sCPR[158].nDCStart =535;   sT[0].sCP[0].sCPR[158].nDCNum =1;    sT[0].sCP[0].sCPR[158].nSCStart= 536;   sT[0].sCP[0].sCPR[158].nAckStart=537;	 sT[0].sCP[0].sCPR[158].nAckNum =1;   sT[0].sCP[0].sCPR[158].nSPOffsetCS=2763; sT[0].sCP[0].sCPR[158].nSPOffsetLek= 2784; 	
...
sT[0].sTI[84].nType = TYP_TMOK;
	...
	sT[0].sMOT[84].nIEC_NM				= 297;		/* Mérések IEC kezdõcíme */
/* 43-14  -----------------------------------------------------------*/	
...
sT[0].sTI[206].nType = TYP_TMOK;
	...
	sT[0].sMOT[206].nIEC_NM				= 715;		/* Mérések IEC kezdõcíme */
